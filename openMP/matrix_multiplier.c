...
// one test to show the parallelized code with 10x10 matrix, 100x100, 1000x1000 matrix
// we will get the times for each matrix
// I want the main functoin to run the code and 
// make a table to compare the times ran for rust to do this and openmp to do this
...
void benchmark(const int num_threads, const int N) {
    ...
    printf("Time taken for matrix size N = %d and threads = %d completed with time = %f \n", N, num_threads, total_time);
}
